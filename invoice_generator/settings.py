...
# this will redirect user to index page after successfull login
LOGIN_REDIRECT_URL = 'index'

# this will redirect to login page if user is trying to access page which requires to be logged in 
LOGIN_URL = 'login'
